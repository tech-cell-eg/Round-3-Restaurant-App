...
import 'package:food_app/features/chef/notification/model/massage_model.dart';
import 'package:food_app/features/chef/notification/model/notification_model.dart';
...
class _NotificationScreenState extends State<NotificationScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(tabController.index == 0 ? 'Notifications' : 'Messages'),
        bottom: TabBar(
